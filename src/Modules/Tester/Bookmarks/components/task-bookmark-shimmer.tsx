    ...
    >
      <div className=''>
        ...
        <div className='flex gap-x-2.5 items-stretch'>
          <div className='w-[32px]'>
            <Shimmers.SingleShimmer innerHeight="h-[32px]" />
          </div>
          <div className='w-[32px]'>
          <Shimmers.SingleShimmer innerHeight="h-[32px]" />
          </div>
      ...
      <div className='flex items-center gap-5 '>
        <div className='w-[100px] '>
          <Shimmers.SingleShimmer outerHeight="h-[70px]" innerHeight="h-[70px]"/>
        </div>
        <div className='w-[100px] '>
        <Shimmers.SingleShimmer  outerHeight="h-[70px]"  innerHeight="h-[70px]"/>
        </div>
...
export default TaskBookMarkShimmer;
