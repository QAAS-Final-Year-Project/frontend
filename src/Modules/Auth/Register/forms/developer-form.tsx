...
const DeveloperForm: FC = () => {
  ...
  const mutation = useMutation({
    ...
    onSuccess: (data) => {
      ...
      navigate(
        "/verify-email?accountType=Developer&email=" + form.values.emailAddress
      );
    },
    onError: (error) => {
      if (
  ...
  const form = useFormik<ICreateDeveloperUser>({
    initialValues: {
      emailAddress: "",
      fullName: "",
      password: "",
    ...
    validationSchema: DeveloperUserSchema,
        ...
        <div className='mt-16 w-[480px] mx-auto'>
          <div className='  '>
            <h3 className=' text-center text-zinc-800 text-[26px] font-bold leading-[27px] mb-1'>
              Let's create your developer account!
            </h3>
