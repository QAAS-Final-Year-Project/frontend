      ...
      <div className={classNames(labelHidden ? "" : "mt-3", "relative")}>
        <Combobox.Input
          className={classNames(
            ...
            "w-full rounded border border-gray-300 py-2.5 pl-3 pr-10 shadow-sm focus:border-primary-500 focus:outline-none focus:ring-1 focus:ring-primary-500 sm:text-base placeholder:font-light placeholder:text-sm",
            className
          )}
        ...
        {filteredOptions.length > 0 && (
          <Combobox.Options
            className={classNames(
              ...
              "absolute z-10 max-h-56 w-full overflow-auto rounded bg-white py-1 text-base shadow-lg ring-1 ring-black ring-opacity-5 focus:outline-none sm:text-sm"
            )}
          >
            {position === "bottom" && (
              <Combobox.Option
