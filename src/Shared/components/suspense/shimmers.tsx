...
const SingleShimmer = () => (
  <div className="w-full space-y-2 min-w-[120px] h-7  justify-center flex flex-col">
...
const ActionsShimmer = ({ actionsCount }: { actionsCount: number }) => (
  <div className="flex space-x-1 h-10 items-center">
    ...
    <div key={idx} className="odd:bg-gray-400 even:bg-gray-300 dark:bg-gray-400 h-6 rounded-full w-6 animate-pulse" />
    ))}
  </div>
)
