...
const SingleShimmer = () => (
  <div className='w-full space-y-2  h-10  justify-center flex flex-col'>
    <div className='bg-gray-300 dark:bg-gray-300 h-3 rounded-sm w-full animate-pulse' />
  </div>
);
...
const DoubleShimmer = () => (
  <div className='w-full space-y-2  h-10  justify-center flex flex-col'>
    <div className='bg-gray-300 dark:bg-gray-300 h-3 rounded-sm w-full animate-pulse' />
    <div className='bg-gray-300 dark:bg-gray-300 h-3 rounded-sm w-2/3 animate-pulse' />
  </div>
);
